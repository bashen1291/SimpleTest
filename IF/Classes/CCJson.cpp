...
static void dump(double value, string &out) {
    char buf[32];
    snprintf(buf, sizeof buf, "%.7lf", value);
    out += buf;
}
...
protected:
    ...
    const T m_value;
    void dump(string &out) const override { CCJson::dump(m_value, out); }
};
...
class JsonBoolean final : public Value<Json::BOOL, bool> {
    ...
    const string string_value() const override { return m_value ? "true" : "false"; }
public:
