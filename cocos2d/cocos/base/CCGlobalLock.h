...
//#define         GBLK_GLOBAL_LOCK_UNIQUE std::unique_lock<std::recursive_mutex> gblk_lck_varible(cocos2d::GlobalLock::_lock._mtx)
...
//    static void subLockMainThread( int type );
//    static void subUnlockMainThread( int type);
