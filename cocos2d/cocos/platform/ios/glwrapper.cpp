...
void if_glwrapper::glBlendColor (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)
{
...
void if_glwrapper::glClearColor (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)
{
...
int if_glwrapper::glGetAttribLocation (GLuint program, const GLchar* name)
{
    int ret =
...
int if_glwrapper::glGetUniformLocation (GLuint program, const GLchar* name)
{
    int ret =
...
void if_glwrapper::glShaderSource (GLuint shader, GLsizei count, const GLchar* const *string, const GLint* length)
{
