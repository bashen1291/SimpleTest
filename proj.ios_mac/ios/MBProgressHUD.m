...
//        vbtn.frame = CGRectMake(0, 0, 30, 30);
//        [vbtn setTitle:@"+" forState:UIControlStateNormal];
//        [vbtn setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
//        [vbtn addTarget:self action:@selector(hide:) forControlEvents:UIControlEventTouchUpInside];
